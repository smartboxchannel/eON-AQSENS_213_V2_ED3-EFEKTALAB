...
#ifndef _VARIANT_EFEKTA_MWS213_V2_NRF52833_EBYTE
#define _VARIANT_EFEKTA_MWS213_V2_NRF52833_EBYTE
...
#define PIN_SPI_MISO         (4) // P0.048 not conected
#define PIN_SPI_MOSI         (29) // P0.29
#define PIN_SPI_SCK          (31) // P0.31

static const uint8_t SS   = CS_PIN ;  // P0.30
...
#define PIN_WIRE_SDA         (24u) // P0.24
#define PIN_WIRE_SCL         (13u) // P0.13
